        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          >
            <div className="prose prose-lg text-gray-600 leading-relaxed">
              <p className="mb-6">
                My name is Thanakorn Angkasirisan, or unofficially as Kim. My academic background is in experimental psychology. The ultimate goal of my work is to maximise long-term global welfare and ensure a safe transition into the post-AGI era.
              </p>
            </div>
          </div>
